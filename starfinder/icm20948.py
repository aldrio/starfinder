"""
Modified from pimoroni's icm20948-python library

Made changes so that
* Use spi bypass on ICMS20948 so that the magnetometer can be read directly
* Set the magnetometer to continuous mode
"""
...
class ICM20948:
    ...
    def __init__(self, i2c_addr=I2C_ADDR, i2c_bus=None):
        ...
        self.bank(0)
        self.write(ICM20948_INT_PIN_CFG, 0x32)
        ...
        self.mag_write(AK09916_CNTL2, AK09916_CNTL2_MODE_CONT4)
